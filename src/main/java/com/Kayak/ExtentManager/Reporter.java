...
public class Reporter {
   // private static Map systemInfoKeyMap = new HashMap<>();
    ...
    *//**
    ...
    public static ExtentHtmlReporter getExtentHtmlReport() {
        return com.cucumber.listener.ExtentCucumberFormatter.getExtentHtmlReport();
    ...
    *//**
     ...
     *//*
    public static void setTestRunnerOutput(List log) {
